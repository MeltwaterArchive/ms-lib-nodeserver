	...
	appServer.httpManager.routes.dsStats = {
		"put": [
			...
			},
			{
				...
				handler: this.onPutMonitoring.bind(this)
			}
		],
		"del": [
			{
				route: "/stats/monitoring",
				handler: this.onDeleteMonitoring.bind(this)
			},
			{
				route: "/stats/prefix",
...
dsStats.prototype.onPutMonitoring = function(req, res, next) {
	var newConfig = this.appServer.configManager.config;

	// mark that we've started monitoring
...
dsStats.prototype.onDeleteMonitoring = function(req, res, next) {
	var newConfig = this.appServer.configManager.config;

	// mark that we've stopped monitoring
