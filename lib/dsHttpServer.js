...
function dsHttpServer(appServer) {
	...
	this.appServer.on('featureInitialised', this.onFeatureInitialised_HttpServer.bind(this));
}
...
dsHttpServer.prototype.onFeatureInitialised_HttpServer = function(feature) {
